...
* ### Design
    * #### Colour Scheme
        * The Gameracy logo ![Picture of a red and gold D20 with a sword and axe crossed behind it.](../assets/images/readme-images/logo.png) was dropped into [Adobe Colour](https://color.adobe.com/create/image) and the following colour palette was created:
        ![Screenshot of a colour palette taken from Adobe Colour](../assets/images/readme-images/colour-palette.PNG)
